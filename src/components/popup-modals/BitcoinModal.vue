<template>
    <div>
        <div id="Bitcoin-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true"
             style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <ul class="list-unstyled">
                                            <li><i class="fa fa-desktop" aria-hidden="true"></i> Website</li>
                                            <li><i class="fa fa-search" aria-hidden="true"></i> Explorer</li>
                                            <li><i class="fa fa-tasks" aria-hidden="true"></i> Whitepapper</li>
                        ...
                        <div class="tab-pane" id="22">
                            ...
                            <form action="#" data-parsley-validate="" novalidate="">
                                <div class="form-group">
                                    ...
                                    <input id="receiving-address" type="text" placeholder="DinarCoin Address"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Amount in Dinarcoin*</label>
                                    <input id="amount" type="number" placeholder="Amount DinarCoin"
                                           class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" placeholder="Security Password" required=""
                                           class="form-control"
                                           data-parsley-id="8">
