            ...
            <form class="form-horizontal m-t-20" action="index.html">
              ...
              <div class="form-group">
                ...
                <div class="form-group m-t-20">
                    <div class="col-xs-12">
                        <center><button class="btn btn-default btn-custom waves-effect waves-light w-md" type="submit">Register</button></center>
                    </div>
                </div>
