...
export async function sendSigned(rawTransaction) {
   ...
   // var data = web3.eth.sendSignedTransaction('0x' + serializedTx)
    web3.eth.sendSignedTransaction('0x' + serializedTx).then(receipt =>console.log("Trans recipt",receipt)).catch(error =>console.log("Error",error));
//    console.log('Data ' + data);
 ...
 export function getTransactionCount(){
    ...
    web3.eth.getTransactionCount(web3.eth.defaultAccount).then( count => {
        ...
        console.log('getTransactionCount ' + rawTransaction);
        // console.log(rawTransaction);
        sendSigned(rawTransaction);
        // sendSigned(rawTransaction).then(console.log);
    
    }).catch((error)=>{
        console.log('Error i am getting' + error);
    });
